...
|---|---|---|
| Person | email | Communication and account management |

### Identity data

| Entity | Field | Purpose |
|---|---|---|
| Person | legal_name | User identification and account security |
| Person | preferred_name | User identification and account security |
