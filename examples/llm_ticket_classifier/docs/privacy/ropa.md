# Record of Processing Activities — Support Ticket Classifier
...
<!-- DZ-AUTO:start name="ropa" -->

| Activity | Data categories | Recipients | Jurisdiction | Retention | Legal basis |
|---|---|---|---|---|---|
| Service operations | contact, freeform | (no external subprocessors) | - | see retention policy | contract / legitimate interest |

<!-- DZ-AUTO:end -->

## Cross-border transfers

No processing activities transfer personal data outside the EEA.
