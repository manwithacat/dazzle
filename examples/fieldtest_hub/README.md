...
└── dsl/
    └── app.dsl          # DAZZLE DSL definition (~680 lines)
```

## User Stories

| ID | Story | Persona | Key Feature |
|----|-------|---------|-------------|
| US-1 | Log an issue quickly | Tester | Issue report form with defaults |
| US-2 | Track my reports | Tester | Scoped issue list |
| US-3 | Record usage sessions | Tester | Test session logging |
| US-4 | See issue clusters | Engineer | Filtered issue board |
| US-5 | Filter by firmware | Engineer | Complex filtering |
| US-6 | Escalate issues to tasks | Engineer | Task creation |
| US-7 | Run recalls | Engineer | Device status management |
...
**Previous**: `ops_dashboard` (Intermediate+) - Personas, engine hints
...
### Engineering Dashboard
![Engineering Dashboard](screenshots/engineering_dashboard.png)

### Issue Board
![Issue Board](screenshots/issue_board.png)

### Device Dashboard
![Device Dashboard](screenshots/device_dashboard.png)
