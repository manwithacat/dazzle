...
|---|---|---|
| Tester | email | Communication and account management |

### Identity data

| Entity | Field | Purpose |
|---|---|---|
| Tester | name | User identification and account security |

### Location data

| Entity | Field | Purpose |
|---|---|---|
| Tester | location | Service localisation and access control |
