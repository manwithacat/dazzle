...
- **Pay Desk** — finance home (multi-panel settlement): metrics, a **draft packet
  ...
  or credit|debit adjustment_rail re-stack), a **remittance advice watch** of SEPA/ACH covers
...
- **Finance Operations** — shared ops overview: **packet cover wall** first
  ...
  (doc_kind=dispute_packet or credit_memo — cycle 2033; not dispute|debit dispute_rail or credit|debit adjustment_rail re-stack), a **remittance advice watch**
...
<!-- dazzle-spec-brief: sha256:6e604a8bddc20a513b1b19742f978a2fd1fc4a2d8b3c26f631ccf216a237a462 -->
