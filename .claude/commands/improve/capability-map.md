...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 2404 | USED |
...
| `dazzle fragment-audit` | HYGIENE | CLI | framework-ux | 2403 | USED |
...
| **CodeQL / code-scanning** | DRIVER | GitHub API + strategy | **driver (Step 0c2)** | 2404 | USED |
| **GitHub inbox** | DRIVER | GitHub API + strategies | **driver (Step 0c3)** | 2404 | USED |
