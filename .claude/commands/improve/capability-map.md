...
|---|---|---|---|---|---|
| `dazzle domain` / MCP `domain` (extract/gaps/research/promote) | COGNITION | CLI+MCP | **example-apps** + agent DX | 1976 | USED |
| **domain lifecycle/process priors** (`domain_brief.lifecycles` + `domain_cognition_bar`) | COGNITION | script + extract | **example-apps** | 1976 | USED |
| MCP `product_quality` (persona homes + stills + maturity + metric_list + **presentation residual**) | COGNITION | MCP | **example-apps** + framework-ux | 1978 | USED |
| `dazzle demo quality` (#1626 felt residual bar) | COGNITION | CLI | **example-apps** + framework-ux | 1978 | USED |
...
| **interesting_product** (post-5.8 Goal B depth menu + still proof) | COGNITION | strategy + doctrine | **example-apps** | 1978 | USED |
| doctrine `interesting-saas-context` (Goal A harness vs Goal B) | COGNITION | docs | example-apps + driver | 1624 | STALE |
| `dazzle demo reset-and-load` (#1627 closed-loop seed) | COGNITION | CLI | example-apps + agent DX | 1978 | USED |
...
| **example product maturity** / WI D/N/L/J/G | COGNITION | script + strategy | **example-apps** | 1976 | USED |
| **demo fleet bar** (#1626) | COGNITION | script + strategy | **example-apps** | 1976 | USED |
| **example journey maturity** | COGNITION | script + strategy | **example-apps** | 1976 | USED |
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 1976 | USED |
...
| **story_walk bar** / dig contracts (#1638) | COGNITION | script + strategy | **example-apps** | 1976 | USED |
| `dazzle test walk` (validate/run/dry-run) | COGNITION | CLI | **example-apps** | 1896 | USED |
| **process_dig / dig contracts sensors** (`improve_dig_receipt`, probe process_dig) | COGNITION | script + probes | **example-apps** + driver | 1978 | USED |
...
| gallery_probes (`hm_gallery_probes.py`) | HYGIENE | script | **hm-convergence** | 1976 | USED |
| `dazzle validate` / `lint` | HYGIENE | CLI | example-apps (Tier 1) | 1978 | USED |
| `dazzle ux verify` (contracts/interactions) | HYGIENE | CLI | framework-ux, ux-converge, example-apps | 1534 | STALE |
| `dazzle qa capture` (Tier-2 visual scrape) | HYGIENE | CLI | example-apps (visual_tier2) | 1978 | USED |
| `dazzle qa login` | HYGIENE | CLI | (support for capture/verify) | 1231 | STALE |
| `hm gallery interaction probes` | HYGIENE | script + strategy | **hm-convergence** | 1976 | USED |
...
| `dual_lock_queue` / `dual_lock_expand` | HYGIENE | script + strategy | **hm-convergence** | 1976 | USED |
...
| **CodeQL / code-scanning** | DRIVER | GitHub API + strategy | **driver (Step 0c2)** | 1976 | USED |
| **GitHub inbox** | DRIVER | GitHub API + strategies | **driver (Step 0c3)** | 1976 | USED |
...
> **Cycle 1976 (2026-08-12).** capability-sweep: UNOWNED=0 COGNITION_STALE_eff≈24 HYGIENE_STALE_eff≈32; domain extract invoice_ops+support_tickets+hr_records; validate 3 apps green (advisory only); gallery 48/48; dual_lock queue=0; tip green @10bad6550; next interesting_product (aggressive) / presentation·coherence STALE digs.
> **Cycle 1974 (2026-08-12).** interesting_product invoice_ops remittance_advice_watch @10bad6550.
> **Cycle 1972 (2026-08-12).** interesting_product support raised_escalation_trail @d7bb08600.
> **Cycle 1956 (2026-08-12).** capability-sweep domain extract+validate+gallery; dual_lock=0 @3b90b8268.
> **Cycle 1955 (2026-08-12).** agent_qa_smoke residual 3→0 + support awaiting_customer @5ef8dba2f.
