...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 1428 | USED |
...
| **work-surface utility ontology** | COGNITION | `work_surface_utility.toml` + `scripts/work_surface_utility.py` + `pick-a-work-surface.md` | **hm-convergence** + framework-ux | 1428 | USED |
...
| `dazzle validate` / `lint` | HYGIENE | CLI | example-apps (Tier 1) | 1428 | USED |
...
| fitness **engine** | HYGIENE | Python API | framework-ux | 1427 | USED |
...
| `dazzle fitness` CLI | HYGIENE | CLI | framework-ux | 1427 | USED |
