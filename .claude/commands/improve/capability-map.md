...
| **example product maturity** / WI D/N/L/J/G | COGNITION | script + strategy | **example-apps** | 1197 | USED |
...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 1197 | USED |
...
| **HM hyperpart coherence** | COGNITION | script + strategy | **hm-convergence** | 1187 | USED |
| gallery_probes (`hm_gallery_probes.py`) | HYGIENE | script | **hm-convergence** | 1187 | USED |
...
| **CodeQL / code-scanning** | DRIVER | GitHub API + strategy | **driver (Step 0c2)** | 1197 | USED |
| **GitHub inbox** | DRIVER | GitHub API + strategies | **driver (Step 0c3)** | 1197 | USED |
