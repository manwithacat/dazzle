...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 2150 | USED |
...
| `dual_lock_queue` / `dual_lock_expand` | HYGIENE | script + strategy | **hm-convergence** | 2149 | USED |
