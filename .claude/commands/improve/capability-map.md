...
| **work-surface utility ontology** | COGNITION | `work_surface_utility.toml` + `scripts/work_surface_utility.py` + `pick-a-work-surface.md` | **hm-convergence** + framework-ux | 1431 | USED |
...
| `dazzle validate` / `lint` | HYGIENE | CLI | example-apps (Tier 1) | 1431 | USED |
