...
| counter-prior `ref_as_repr` (dict/UUID chrome) | COGNITION | KG + docs | framework-ux + example-apps | 2325 | USED |
...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 2325 | USED |
