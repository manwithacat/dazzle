...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 1574 | USED |
...
| `dazzle test walk` (validate/run/dry-run) | COGNITION | CLI | **example-apps** | 1574 | USED |
| **process_dig / dig contracts sensors** (`improve_dig_receipt`, probe process_dig) | COGNITION | script + probes | **example-apps** + driver | 1574 | USED |
...
| `dazzle validate` / `lint` | HYGIENE | CLI | example-apps (Tier 1) | 1574 | USED |
...
| `dazzle prove` | HYGIENE | CLI | framework-ux + example-apps | 1574 | USED |
