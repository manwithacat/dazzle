...
| `dazzle qa trial` | COGNITION | CLI | trials | 1442 | USED |
...
| gallery_probes (`hm_gallery_probes.py`) | HYGIENE | script | **hm-convergence** | 1451 | USED |
...
| `hm gallery interaction probes` | HYGIENE | script + strategy | **hm-convergence** | 1451 | USED |
