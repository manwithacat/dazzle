...
| `dazzle demo reset-and-load` (#1627 closed-loop seed) | COGNITION | CLI | example-apps + agent DX | 2095 | STALE |
...
| **unified example probes** | COGNITION | script | **example-apps** (driver) | 2146 | USED |
...
| gallery_probes (`hm_gallery_probes.py`) | HYGIENE | script | **hm-convergence** | 2145 | USED |
...
| `hm gallery interaction probes` | HYGIENE | script + strategy | **hm-convergence** | 2145 | USED |
...
| **CodeQL / code-scanning** | DRIVER | GitHub API + strategy | **driver (Step 0c2)** | 2146 | USED |
| **GitHub inbox** | DRIVER | GitHub API + strategies | **driver (Step 0c3)** | 2146 | USED |
...
> **Cycle 2132 (2026-08-15).** capability-sweep: UNOWNED=0 COGNITION_STALE_eff=31 HYGIENE_STALE_eff=33; Goal B recommend=- (icon cells sat); residual=0 densify_allowed=0; dual_lock=0 coherence=0; next → framework-ux (campaign; not another coat) / presentation·MCP STALE (1554) / slider·color leftover class.
