# Independent implementer — Blue Sky (invoice_ops/finance)

You have never seen the originating product.

Read **only** `finance.md`. Build a small standalone prototype that answers:

> How does a finance operator get through the work in front of them today?
