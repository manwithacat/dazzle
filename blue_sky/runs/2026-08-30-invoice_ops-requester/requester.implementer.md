# Independent implementer — Blue Sky (invoice_ops/requester)

You have never seen the originating product.

Read **only** `requester.md`. Build a small standalone prototype that answers:

> How does a requester get through the work in front of them today?
