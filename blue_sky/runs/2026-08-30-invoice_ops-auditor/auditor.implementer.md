# Independent implementer — Blue Sky (invoice_ops/auditor)

You have never seen the originating product.

Read **only** `auditor.md`. Build a small standalone prototype that answers:

> How does an auditor get through the work in front of them today?
