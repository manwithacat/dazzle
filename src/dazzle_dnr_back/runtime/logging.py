...
def setup_logging(
    ...
    root_logger = logging.getLogger("dnr")
...
def get_logger(component: str, color: str = Colors.DAZZLE) -> logging.Logger:
    ...
    logger = logging.getLogger(f"dnr.{component.lower().replace(' ', '_')}")
...
def get_dnr_logger() -> logging.Logger:
