...
Provides /_dnr/events/* endpoints for inspecting the event system,
...
if TYPE_CHECKING:
    from dazzle_dnr_back.events.framework import EventFramework
...
def create_event_explorer_routes(framework: EventFramework | None) -> APIRouter:
    ...
    router = APIRouter(prefix="/_dnr/events", tags=["Event Explorer"])
