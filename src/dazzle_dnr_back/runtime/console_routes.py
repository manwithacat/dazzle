...
TEMPLATES_DIR = (
    Path(__file__).parent.parent.replace("dazzle_dnr_back", "dazzle_dnr_ui") if False else None
)  # noqa: E501
...
def _get_templates_dir() -> Path:
    """Resolve templates directory from dazzle_dnr_ui package."""
    import dazzle_dnr_ui

    return Path(dazzle_dnr_ui.__file__).parent / "templates"
...
def create_console_routes(
    ...
    from dazzle_dnr_back.runtime.ops_routes import OpsSessionManager
