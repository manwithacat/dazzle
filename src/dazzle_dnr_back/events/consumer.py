...
from dazzle_dnr_back.events.bus import EventBus, NackReason
from dazzle_dnr_back.events.envelope import EventEnvelope
from dazzle_dnr_back.events.inbox import EventInbox, ProcessingResult
...
def idempotent(
    ...
    *,
    ...
    Usage:
        @idempotent("order-processor", db_path="app.db")
