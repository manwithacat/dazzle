...
import { createApp } from '@dazzle/app.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.dazzleApp = app;
});
"""

# Note: DAZZLE_CSS has been removed. CSS is now loaded dynamically from static/css/
...
class ViteGenerator:
    ...
    def generate_package_json(self) -> str:
        ...
        name = self.spec.name or "dazzle-app"
    ...
    def generate_index_html(self) -> str:
        ...
        title = self.spec.name or "Dazzle UI"
    ...
    def write_to_directory(
        ...
        css_file = styles_dir / "dazzle.css"
