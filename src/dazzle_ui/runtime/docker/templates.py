...
DAZZLE_FRONTEND_DOCKERFILE = """# Runtime Frontend Container
# Generated by Dazzle Runtime - Vite dev server
FROM node:20-slim
...
DAZZLE_COMPOSE_TEMPLATE = """# Runtime Docker Compose - Split Containers
# Generated by Dazzle Runtime
name: {project_name}
