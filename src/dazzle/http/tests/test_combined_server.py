...
from dazzle.http.runtime.combined_server import (
    _clickable_url,
...
class TestModuleExports:
    ...
    def test_run_unified_server_exported(self) -> None:
        """run_unified_server is available from dazzle.http.runtime.combined_server."""
        from dazzle.http.runtime.combined_server import run_unified_server as fn

        assert callable(fn)

    def test_run_backend_only_exported(self) -> None:
        """run_backend_only is available from dazzle.http.runtime.combined_server."""
        from dazzle.http.runtime.combined_server import run_backend_only as fn

        assert callable(fn)

    def test_old_combined_server_not_exported(self) -> None:
        """DNRCombinedHandler / DNRCombinedServer / run_combined_server are removed."""
        import dazzle.page.runtime as mod
