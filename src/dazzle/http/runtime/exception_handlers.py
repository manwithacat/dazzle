...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    from dazzle.http.runtime.htmx_response import HtmxDetails, json_or_htmx_error
    from dazzle.http.runtime.invariant_evaluator import InvariantViolationError
    from dazzle.http.runtime.repository import ConstraintViolationError
    from dazzle.http.runtime.state_machine import TransitionError
...
def _render_app_shell_error(
    *,
    ...
    with typed views in `dazzle.http.runtime.app_error_views`. The
