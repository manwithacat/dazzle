...
if TYPE_CHECKING:
    ...
    from dazzle.http.runtime.event_bus import EntityEvent
    from dazzle.http.runtime.llm_executor import ExecutionResult
    from dazzle.http.runtime.llm_queue import LLMJob, LLMJobQueue
