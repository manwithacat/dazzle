...
async def _list_handler_body(
    ...
    # email match. Valid keys / declared options / UUIDs / ISO dates
    # / bool tokens / integer and decimal tokens / emails ride;
    # leftover restores unfiltered (omit). leftover_honest_iso_date
    # already exists (oral #70). Oral #79 — do not walk another
    # GET list numeric VALUE.
