...
from dazzle.http.runtime.ops_database import ApiCallRecord, OpsDatabase
    ...
    def __init__(
        ...
        **httpx_kwargs: Any,
        ...
        self._client = httpx.AsyncClient(
            base_url=base_url, **httpx_kwargs
        )  # DZ-HTTP-NORETRY  persistent client; retry policy decided by caller
