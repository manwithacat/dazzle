...
The pure evaluation logic lives in dazzle.page.utils.condition_eval so that
the UI package can evaluate visible_condition without importing dazzle.http.
