...
class AuthSubsystem:
    ...
    def _register_auth_routes(self, ctx: SubsystemContext) -> None:
        ...
        from dazzle.http.runtime.auth import create_2fa_routes, create_auth_routes
        ...
        from dazzle.http.runtime.auth.org_activation import derive_memberships_required
        ...
        if guides_present and db_url_present:
            from dazzle.http.runtime.onboarding import (
        ...
        from dazzle.http.runtime.auth.password_reset_routes import (
        ...
        try:
            from dazzle.http.channels.ses_webhooks import register_ses_webhook
    ...
    def _mount_enterprise_sso(self, ctx: SubsystemContext) -> None:
        ...
        """
        from dazzle.http.runtime.auth.enterprise_routes import (
    ...
    def _register_jwt_routes(self, ctx: SubsystemContext) -> None:
        ...
        try:
            from dazzle.http.runtime.auth import create_jwt_auth_routes
        except ImportError as e:
    ...
    def _build_social_auth_config(self, oauth_providers: list[Any]) -> Any | None:
        ...
        from dazzle.http.runtime.social_auth import SocialAuthConfig
