...
from dazzle.page.specs.component import ComponentSpec
from dazzle.page.specs.shell import ShellSpec
from dazzle.page.specs.theme import ThemeSpec
from dazzle.page.specs.workspace import WorkspaceSpec
