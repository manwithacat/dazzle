...
DISPLAY_TEMPLATE_MAP: dict[str, str] = {
    ...
    "COMPARISON": _TYPED_SHIM,  # #1470 ranked league
    "BULLET": _TYPED_SHIM,
...
STAGE_FOLD_COUNTS: dict[str, int] = {
    ...
    # monitor_wall@1433 / dual_pane@1427). Cap at three above-the-fold
    # (first pair + lead panel of second); rest intersect-once.
    "pair_strip": 3,
}
