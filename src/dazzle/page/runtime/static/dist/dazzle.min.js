...
(function () {
  ...
  // immutable data-dz-grid-src query the server baked. Absent attr falls
  ...
  function srcQueryParams(root) {
    ...
    var srcQs =
      ((body && body.getAttribute("data-dz-grid-src")) || "").split("?")[1] ||
      "";
    return new URLSearchParams(srcQs);
  }

  function readIncludeClosed(root) {
    if (root.hasAttribute("data-dz-grid-include-closed")) {
      return parseIncludeClosed(
        root.getAttribute("data-dz-grid-include-closed"),
      );
    }
  ...
  function readAsOf(root) {
    if (root.hasAttribute("data-dz-grid-as-of")) {
      return parseAsOf(root.getAttribute("data-dz-grid-as-of"));
    }
    var urlSp = new URLSearchParams(location.search);
  ...
  function restoreFromUrl(root) {
    ...
    if (sp.has("as_of")) {
      ...
      root.setAttribute("data-dz-grid-as-of", init.as_of || "");
    }
    setQuery(root);
  }
 ...
 *             `data-dz-edit-kind` (text|date|time|number|bool|select),
 ...
 *             (dz-number.js). Number columns map here (not kind=text)
...
(function () {
  ...
  function buildEditor(edit) {
    ...
    if (edit.kind === "bool") {
      ...
      // (cycle 2155). Compose Field number so dz-number.js owns parse/validity.
      el = document.createElement("span");
      el.className = "dz-inline-edit-number";
      el.setAttribute("data-dz-number-group", "");
      var nNative = document.createElement("input");
      nNative.type = "number";
      nNative.step = "any";
      nNative.className = "dz-inline-edit-input dz-inline-edit-number-native";
      nNative.value = edit.value;
      nNative.setAttribute("aria-label", "Edit " + (edit.label || edit.colKey));
      var nOut = document.createElement("input");
      nOut.type = "text";
      nOut.className = "dz-inline-edit-input dz-inline-edit-number-out";
      nOut.setAttribute("data-dz-number-value", "");
  ...
  function openEditor(root) {
    ...
    var iso =
      ...
      (editor.querySelector("[data-dz-date-iso]") ||
        ...
        editor.querySelector("[data-dz-number-value]"));
    if (iso) {
      iso.focus();
  ...
  function numberLeftoverBlocksCommit(root, target) {
    ...
    var out = editor.querySelector("[data-dz-number-value]");
    if (target && native && (target === native || native.contains(target))) {
      return false;
    }
    if (!out) return false;
...
(function () {
  ...
  function leftoverKind(root, raw) {
    ...
    options(root).forEach(function (o) {
      ...
      var value = (o.getAttribute("data-dz-value") || "").trim();
      if (
 ...
 *   [data-dz-pdf-zoom] [data-dz-pdf-fit-width] [data-dz-pdf-status]
 *   [data-dz-pdf-viewer]
 *
 ...
 * invalid — the canvas stays put and the optional [data-dz-pdf-zoom]
 ...
 * input under [data-dz-field-widget=toggle] (Dazzle ToggleField) must
...
(function () {
  ...
  function fieldHostOf(btn) {
    return (
      (btn.closest && btn.closest("[data-dz-field-widget='toggle']")) ||
