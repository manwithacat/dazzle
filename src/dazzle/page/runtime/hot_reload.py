...
SOURCE_PATTERNS: list[str] = ["*.py", "*.css", "*.js"]
...
class HotReloadManager:
    ...
    def _start_source_watcher(self) -> None:
        ...
        # Find the dazzle_page package directory
        ...
        try:
            ...
            pkg_path = Path(dazzle_page.__file__).parent
        ...
        dev_locations = [
            ...
            self.project_root.parent / "src" / "dazzle" / "page" / "runtime",
            Path.cwd() / "src" / "dazzle" / "page" / "runtime",
        ]
    ...
    def _reload_python_modules(self, changed_file: Path) -> None:
        ...
        modules_to_reload = [
            "dazzle.page.runtime.site_renderer",
            "dazzle.page.runtime.css_loader",
