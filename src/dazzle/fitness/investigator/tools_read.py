"""Investigator read-side tools.

All four read tools — read_file, query_dsl, get_cluster_findings,
get_related_clusters — live here along with their private helpers.
These tools are stateless with respect to the repo: they observe but
