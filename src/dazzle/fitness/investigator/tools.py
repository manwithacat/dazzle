...
- tools_write.py    — stub; search_spec (Task 13) and propose_fix (Task 14) land here
"""
...
def build_investigator_tools(
    *,
    ...
    return [
        ...
        # Task 13: _search_spec_tool from .tools_write
        # Task 14: _propose_fix_tool from .tools_write
    ]
