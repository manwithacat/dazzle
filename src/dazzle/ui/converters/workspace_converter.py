...
# Re-exported for ui/testing callers that import it from this module. The
...
# `workspace_allowed_personas` is re-exported from dazzle.core.access at the top
# of this module (see import). It remains importable from here unchanged for
# ui/testing callers.
