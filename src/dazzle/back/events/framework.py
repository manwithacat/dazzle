...
from dazzle.back.events.bus import EventBus, EventHandler
from dazzle.back.events.consumer import ConsumerConfig, IdempotentConsumer
...
class EventFramework:
    ...
    async def start(self) -> None:
        ...
        from dazzle.back.events.tier import EventTier, TierConfig, create_bus
