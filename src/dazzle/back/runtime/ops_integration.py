...
from dazzle.back.runtime.analytics_collector import (
    AnalyticsCollector,
    AnalyticsConfig,
    create_analytics_routes,
)
from dazzle.back.runtime.api_middleware import (
    ApiTrackingMiddleware,
    create_tracked_client,
)
from dazzle.back.runtime.api_tracker import (
    ApiTracker,
    configure_anthropic_tracking,
    configure_openai_tracking,
)
from dazzle.back.runtime.email_templates import (
    BrandConfig,
    EmailTemplateEngine,
...
if TYPE_CHECKING:
    ...
    from dazzle.back.events.bus import EventBus
    from dazzle.back.runtime.websocket_manager import WebSocketManager
...
class OpsPlatform:
    ...
    def set_appspec(self, appspec: Any) -> None:
        ...
        try:
            from dazzle.back.runtime.spec_versioning import SpecVersionStore
        ...
        try:
            from dazzle.back.runtime.deploy_history import DeployHistoryStore
        ...
        try:
            from dazzle.back.runtime.rollback_manager import RollbackManager
...
def mount_ops_platform(
    ...
    Example:
        ```python
        from fastapi import FastAPI
        from dazzle.back.runtime.ops_integration import mount_ops_platform
    ...
    try:
        ...
        ui_path = Path(dazzle_ui.__file__).parent / "runtime" / "static" / "ops"
        if ui_path.exists():
            app.mount(
                "/_ops/ui",
