...
# =============================================================================
# Channel conversion (moved from dazzle.back.converters)
# =============================================================================
...
class IntegrationManager:
    ...
    def init_channel_manager(self) -> None:
        ...
        try:
            from dazzle.back.channels import create_channel_manager
    ...
    def init_integration_executor(self) -> None:
        ...
        try:
            from dazzle.back.runtime.integration_executor import IntegrationExecutor
