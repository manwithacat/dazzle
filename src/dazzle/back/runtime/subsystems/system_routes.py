...
class SystemRoutesSubsystem:
    ...
    def _setup_optional_features(self, ctx: SubsystemContext) -> None:
        ...
        from dazzle.back.runtime.integration_manager import IntegrationManager
        ...
        # Debug routes
        if ctx.db_manager:
            from dazzle.back.runtime.debug_routes import create_debug_routes
            ...
            from dazzle.back.runtime.event_explorer import create_event_explorer_routes
        ...
        if ctx.sitespec_data:
            from dazzle.back.runtime.site_routes import create_site_routes
    ...
    def _init_fragment_routes(self, ctx: SubsystemContext) -> None:
        ...
        try:
            ...
            from dazzle.back.runtime.fragment_routes import create_fragment_router
    ...
    def _init_transition_effects(self, ctx: SubsystemContext) -> None:
        ...
        from dazzle.back.runtime.transition_effects import TransitionEffectRunner
