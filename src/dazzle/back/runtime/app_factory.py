...
def assemble_post_build_routes(
    ...
    *,
    ...
    if get_auth_context and appspec.personas:
        try:
            from dazzle.ui.converters.workspace_converter import compute_persona_default_routes
    ...
    if sitespec_data:
        try:
            from dazzle.back.runtime.site_routes import (
...
def create_app_factory(
    ...
    Usage:
        uvicorn dazzle.back.runtime.app_factory:create_app_factory --factory --host 0.0.0.0 --port $PORT

    Multi-worker (production):
        uvicorn dazzle.back.runtime.app_factory:create_app_factory --factory --host 0.0.0.0 --port $PORT --workers 4

    Procfile example:
        web: uvicorn dazzle.back.runtime.app_factory:create_app_factory --factory --host 0.0.0.0 --port $PORT --workers ${WEB_CONCURRENCY:-4}
