...
def create_site_page_routes(
    ...
    *,
    ...
    def _render_site_inner_html(request: Request, ctx: Any) -> str:
        ...
        from dazzle.ui.runtime.theme import is_dark_mode_toggle_enabled
...
def create_auth_page_routes(
    ...
    async def login_sent_page(
        ...
        from dazzle.back.runtime.auth.auth_views import build_login_sent_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def forgot_password_page(
        ...
        from dazzle.back.runtime.auth.auth_views import build_forgot_password_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def forgot_password_sent_page(
        ...
        from dazzle.back.runtime.auth.auth_views import build_forgot_password_sent_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def reset_password_page(
        ...
        from dazzle.back.runtime.auth.auth_views import build_reset_password_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def reset_password_done_page(
        ...
        from dazzle.back.runtime.auth.auth_views import build_reset_password_done_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def two_factor_settings_page(
        ...
        if redirect is not None:
            return redirect
        from dazzle.back.runtime.auth.two_factor_views import build_2fa_settings_view
        from dazzle.render.fragment.renderer import FragmentRenderer
    ...
    async def two_factor_challenge_page(
        ...
        """
        from dazzle.back.runtime.auth.two_factor_views import build_2fa_challenge_view
        from dazzle.render.fragment.renderer import FragmentRenderer
