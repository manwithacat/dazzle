...
def run_unified_server(
    ...
    *,
    ...
    # Initialize logging
    try:
        from dazzle.back.runtime.logging import setup_logging
    ...
    try:
        ...
        from dazzle.ui.themes import generate_theme_css, resolve_theme
    ...
    if enable_watch and (workers is None or workers == 1) and project_root is not None:
        try:
            from dazzle.ui.runtime.hot_reload import HotReloadManager, create_reload_callback
    ...
    try:
        if workers is not None and workers > 1:
            ...
            uvicorn.run(
                "dazzle.back.runtime.app_factory:create_app_factory",
                factory=True,
                **uvicorn_kwargs,
            )
        else:
...
def run_backend_only(
    ...
    if enable_graphql:
        try:
            from dazzle.back import convert_appspec_to_backend
