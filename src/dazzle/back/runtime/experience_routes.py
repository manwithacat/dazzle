...
def _persist_progress(
    ...
    from dazzle.ui.runtime.experience_persistence import ExperienceProgress
...
async def _experience_entry(deps: _ExperienceDeps, request: Request, name: str) -> Response:
    ...
    raw_cookie = request.cookies.get(cname)
    from dazzle.ui.runtime.experience_state import verify_state
...
async def _experience_step_get(
    ...
    """GET /experiences/{name}/{step} — render a step."""
    from dazzle.ui.runtime.experience_renderer import render_experience_inner_html
    from dazzle.ui.runtime.experience_state import (
        cookie_name,
        create_initial_state,
        sign_state,
...
def create_experience_routes(
    ...
    from dazzle.ui.runtime.experience_persistence import ExperienceProgressStore
