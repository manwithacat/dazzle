...
async def _log_frontend_message(
    ...
    """
    from dazzle.back.runtime.logging import log_frontend_entry
...
async def _get_logs(
    ...
    """
    from dazzle.back.runtime.logging import get_log_file, get_recent_logs
...
async def _get_error_summary(deps: _ControlPlaneDeps) -> dict[str, Any]:
    ...
    """
    from dazzle.back.runtime.logging import get_error_summary
...
async def _clear_logs(deps: _ControlPlaneDeps) -> dict[str, Any]:
    ...
    """
    from dazzle.back.runtime.logging import clear_logs
