...
def inspect_process_handler(project_root: Path, args: dict[str, Any]) -> str:
    ...
    # Get linked stories
    linked_stories = [
        {"story_id": s.story_id, "title": s.title} for s in stories if s.story_id in proc.implements
    ]
    ...
    return json.dumps(
        {
            ...
            "outputs": [
                {"name": o.name, "type": o.type, "description": o.description} for o in proc.outputs
            ],
