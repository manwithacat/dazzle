...
Post-#1051 (v0.67.85+) only the typed FragmentSurfaceRenderer is shipped
as a default; downstream apps can register their own. The dispatcher's
only job is to look up the handler by name and call it.
"""
