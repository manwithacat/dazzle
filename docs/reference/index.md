...
| [Demo Identity & Cognition](demo.md) | Agent-facing priors for commercial demos: STABLE persona identities, reset-and-load, empty-desk false greens, and version cognition. |
