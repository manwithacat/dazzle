...
Dazzle targets cloud deployments where apps are built from high-level DSL specifications and served by the FastAPI runtime (`src/dazzle/http/`). The runtime requires:
