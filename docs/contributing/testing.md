...
#### Backend Tests (`src/dazzle/http/tests/`)
...
#### UI Tests (`src/dazzle/page/tests/`)
...
**Location:** `src/dazzle/page/runtime/static/js/*.test.js`
...
| Backend runtime | `src/dazzle/http/tests/` | ✅ | ❌ | ✅ |
| UI runtime | `src/dazzle/page/tests/` | ✅ | ❌ | ✅ |
| JavaScript | `*.test.js` | ✅ | ✅ | ✅ |
