...
| Backend capability | `src/dazzle/back/` | New API pattern |
| UI component | `src/dazzle/ui/` | New widget |
...
Add to `src/dazzle/back/services/`:
...
Create `src/dazzle/back/tests/test_my_service.py`:
...
Add to `src/dazzle/ui/runtime/static/js/components/`:
...
Add to `src/dazzle/ui/runtime/static/js/components.js`:
...
Create `src/dazzle/ui/runtime/static/js/my-component.test.js`:
