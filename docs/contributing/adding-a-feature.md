...
| Backend capability | `src/dazzle/http/` | New API pattern |
| UI component | `src/dazzle/page/` | New widget |
...
Add to `src/dazzle/http/services/`:
...
Create `src/dazzle/http/tests/test_my_service.py`:
...
Add to `src/dazzle/page/runtime/static/js/components/`:
...
Add to `src/dazzle/page/runtime/static/js/components.js`:
...
Create `src/dazzle/page/runtime/static/js/my-component.test.js`:
