...
| `src/dazzle_back/runtime/renderers/fragment_adapter.py` | `_field_to_primitive` — the type→primitive map |
| `src/dazzle_ui/runtime/static/css/components/fragment-primitives.css` | per-primitive CSS rules |
