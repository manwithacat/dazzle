...
def test_manager_ops_media_shelf_first() -> None:
    ...
    assert (
        ...
        "unassigned_queue, needs_reply, critical_awaiting_customer, raised_awaiting_customer, frustrated_awaiting_customer, urgent_awaiting_customer, live_conversation"
        in block
    )
