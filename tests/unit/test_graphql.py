...
class TestGraphQLContext:
    ...
    def test_anonymous_context(self) -> None:
        ...
        from dazzle.back.graphql.context import create_anonymous_context
    ...
    def test_system_context(self) -> None:
        ...
        from dazzle.back.graphql.context import create_system_context
...
class TestSchemaSDL:
    ...
    def test_generate_schema_sdl(self, backend_spec: BackendSpec) -> None:
        """Test SDL generation."""
        from dazzle.back.graphql.schema_generator import generate_schema_sdl
...
class TestIntegration:
    ...
    def test_create_schema(self, backend_spec: BackendSpec) -> None:
        ...
        from dazzle.back.graphql.integration import create_schema
    ...
    def test_inspect_schema(self, backend_spec: BackendSpec) -> None:
        ...
        from dazzle.back.graphql.integration import inspect_schema
...
class TestHelperFunctions:
    ...
    def test_pascal_case(self) -> None:
        ...
        from dazzle.back.graphql.schema_generator import _pascal_case
    ...
    def test_camel_case(self) -> None:
        ...
        from dazzle.back.graphql.resolver_generator import _camel_case
