...
class TestGraphQLContext:
    ...
    def test_context_creation(self) -> None:
        ...
        from dazzle.http.graphql.context import GraphQLContext
    ...
    def test_anonymous_context(self) -> None:
        ...
        from dazzle.http.graphql.context import create_anonymous_context
    ...
    def test_system_context(self) -> None:
        ...
        from dazzle.http.graphql.context import create_system_context
...
class TestSchemaGenerator:
    ...
    def test_generate_types(self, backend_spec: BackendSpec) -> None:
        ...
        from dazzle.http.graphql.schema_generator import SchemaGenerator
...
class TestSchemaSDL:
    ...
    def test_generate_schema_sdl(self, backend_spec: BackendSpec) -> None:
        """Test SDL generation."""
        from dazzle.http.graphql.schema_generator import generate_schema_sdl
...
class TestResolverGenerator:
    ...
    def test_generate_resolvers(self, backend_spec: BackendSpec) -> None:
        ...
        from dazzle.http.graphql.resolver_generator import ResolverGenerator
...
class TestIntegration:
    ...
    def test_create_schema(self, backend_spec: BackendSpec) -> None:
        ...
        from dazzle.http.graphql.integration import create_schema
...
class TestHelperFunctions:
    ...
    def test_pascal_case(self) -> None:
        ...
        from dazzle.http.graphql.schema_generator import _pascal_case
    ...
    def test_camel_case(self) -> None:
        ...
        from dazzle.http.graphql.resolver_generator import _camel_case
