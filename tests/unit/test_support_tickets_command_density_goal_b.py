...
MANAGER_FOCUS = (
    ...
    "at_risk_queue, breached_queue, critical_queue, unassigned_queue, at_risk_needs_reply, "
    "breached_needs_reply, needs_reply, medium_needs_reply, priority_needs_reply, "
    "priority_awaiting_customer, breach_awaiting_customer, breach_needs_reply, "
    "thankful_needs_reply, thankful_awaiting_customer, portal_awaiting_customer, "
    "phone_awaiting_customer, chat_awaiting_customer, email_awaiting_customer, "
    "critical_awaiting_customer, raised_awaiting_customer, frustrated_awaiting_customer, "
    "live_conversation"
)
