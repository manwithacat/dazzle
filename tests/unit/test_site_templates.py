...
class TestBackwardCompatShims:
    """Tests for backward-compatible shims in site_renderer.py."""

    def test_render_site_page_html_shim(self) -> None:
        ...
        page_data = {
            "title": "Home",
            "sections": [{"type": "hero", "headline": "Welcome", "subhead": "Great app"}],
        }
    ...
    def test_render_404_page_html_shim(self) -> None:
    ...
    def test_render_auth_page_html_shim(self) -> None:
    ...
    def test_render_forgot_password_page_html_shim(self) -> None:
    ...
    def test_render_reset_password_page_html_shim(self) -> None:
