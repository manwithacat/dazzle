...
def test_revision_0003_module_loads() -> None:
    mod = importlib.import_module("dazzle.back.alembic.versions.0003_subtype_kind_function")
...
def test_upgrade_calls_op_execute_with_function_sql() -> None:
    from dazzle.back.runtime.triggers import build_assert_subtype_kind_function
