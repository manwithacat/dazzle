...
def test_manager_ops_omits_funnel_and_secondary_ticket_trail() -> None:
    ...
    assert (
        ...
        "unassigned_queue, needs_reply, phone_awaiting_customer, chat_awaiting_customer, email_awaiting_customer, critical_awaiting_customer, raised_awaiting_customer, frustrated_awaiting_customer, live_conversation"
    ) in block
