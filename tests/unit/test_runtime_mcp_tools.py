...
class TestDNRToolNames:
    ...
    def test_backend_tools_defined(self):
        """Verify backend tools are in RUNTIME_TOOL_NAMES."""
        backend_tools = [
            "list_dnr_entities",
            "get_dnr_entity",
        ...
        for tool in backend_tools:
            assert tool in RUNTIME_TOOL_NAMES

    def test_ui_tools_defined(self):
        """Verify UI tools are in RUNTIME_TOOL_NAMES."""
        ui_tools = [
            "list_dnr_components",
...
class TestBackendTools:
    ...
    def test_list_entities_no_spec(self):
        ...
        result = json.loads(handle_runtime_tool("list_dnr_entities", {}))
    ...
    def test_get_entity(self):
        ...
        result = json.loads(handle_runtime_tool("get_dnr_entity", {"name": "Client"}))
...
class TestUITools:
    ...
    def test_list_components_all(self):
        ...
        result = json.loads(handle_runtime_tool("list_dnr_components", {}))
    ...
    def test_list_components_primitives(self):
        ...
        result = json.loads(handle_runtime_tool("list_dnr_components", {"kind": "primitives"}))
    ...
    def test_list_components_patterns(self):
        ...
        result = json.loads(handle_runtime_tool("list_dnr_components", {"kind": "patterns"}))
    ...
    def test_get_component_primitive(self):
        ...
        result = json.loads(handle_runtime_tool("get_dnr_component_spec", {"name": "DataTable"}))
    ...
    def test_get_component_pattern(self):
        ...
        result = json.loads(
            handle_runtime_tool("get_dnr_component_spec", {"name": "FilterableTable"})
        )
        assert "componentSpec" in result
    ...
    def test_get_component_not_found(self):
        ...
        result = json.loads(
            handle_runtime_tool("get_dnr_component_spec", {"name": "UnknownComponent"})
        )
        assert "error" in result

    def test_list_workspace_layouts(self):
        """Test list_workspace_layouts."""
        result = json.loads(handle_runtime_tool("list_workspace_layouts", {}))
