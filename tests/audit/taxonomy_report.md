# Test Suite Taxonomy — Pass 1 (12,806 test functions)
...
|---|---:|---:|---:|
| contract | 10,831 | 84.6% | 0 |
| smoke | 1,326 | 10.4% | 533 |
| parametric_cluster | 416 | 3.2% | 416 |
...
- **Definitely keep**: 11,422 (contract + regression_pin + parametric + snapshot)
- **Review for collapse/rewrite**: 58 (implementation_mirror + belt_and_braces)
- **Smoke tests** (canary; keep but never as sole coverage): 1,326
