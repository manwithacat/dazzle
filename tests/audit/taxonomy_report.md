# Test Suite Taxonomy — Pass 1 (12,327 test functions)
...
|---|---:|---:|---:|
| contract | 10,424 | 84.6% | 0 |
| smoke | 1,253 | 10.2% | 501 |
...
- **Definitely keep**: 11,014 (contract + regression_pin + parametric + snapshot)
- **Review for collapse/rewrite**: 60 (implementation_mirror + belt_and_braces)
- **Smoke tests** (canary; keep but never as sole coverage): 1,253
