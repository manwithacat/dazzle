# Test Suite Taxonomy — Pass 1 (12,815 test functions)
...
|---|---:|---:|---:|
| contract | 10,840 | 84.6% | 0 |
| smoke | 1,330 | 10.4% | 533 |
| parametric_cluster | 412 | 3.2% | 412 |
| regression_pin | 163 | 1.3% | 163 |
...
- **Definitely keep**: 11,427 (contract + regression_pin + parametric + snapshot)
- **Review for collapse/rewrite**: 58 (implementation_mirror + belt_and_braces)
- **Smoke tests** (canary; keep but never as sole coverage): 1,330
