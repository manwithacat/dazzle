...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 4        | 2026-04-12 | Macro + grid/list/kanban/tabbed_list. **4/16 adopters complete.** 12 region files remaining. |
