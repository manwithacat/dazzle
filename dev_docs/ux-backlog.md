...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 3        | 2026-04-12 | Macro + grid + list + kanban. **3/16 adopters complete.** 13 region files remaining. Macro now emits `data-dz-region` attribute. |
