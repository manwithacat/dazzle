...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 2        | 2026-04-12 | Macro + grid (Cycle 32) + list (Cycle 34). **2/16 adopters complete.** 14 region files remaining. |
