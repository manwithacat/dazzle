...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 5        | 2026-04-12 | Macro + grid/list/kanban/tabbed_list/queue. **5/16 adopters complete.** 11 region files remaining. |
