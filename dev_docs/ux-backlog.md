...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 9        | 2026-04-13 | + bar_chart.html. **9/16 adopters complete.** 7 region files remaining. |
