...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 12       | 2026-04-13 | + progress.html. **12/16 adopters.** 4 remaining (detail, heatmap, funnel_chart, tab_data). Semantic pills inline HSL (success/warning), `data-dz-progress` token. |
