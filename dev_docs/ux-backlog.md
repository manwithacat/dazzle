...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 11       | 2026-04-13 | + diagram.html. **11/16 adopters.** 5 remaining (detail, progress, heatmap, funnel_chart, tab_data). |
