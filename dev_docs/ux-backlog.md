...
| UX-017 | form-field         | PENDING   | MISSING  | PENDING  | PENDING | support_tickets   | all                                                              | 0        | —          | individual field macro (templates/macros/form_field.html) — excludes widget-specific logic |
| UX-018 | form-wizard        | PENDING   | MISSING  | DONE     | PENDING | contact_manager   | contact_manager,fieldtest_hub                                    | 0        | —          | multi-step navigation state machine (dzWizard in dz-alpine.js) |
