...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 13       | 2026-04-13 | + heatmap.html. **13/16 adopters.** 3 remaining (detail, funnel_chart, tab_data). Heatmap cells use inline semantic HSL (error/warning/success tints). |
