...
| UX-006 | filter-bar         | PENDING   | DONE     | DONE     | PENDING | contact_manager   | contact_manager,support_tickets                                  | 1        | 2026-04-12 | contract documented retroactively; refactor was done as part of UX-002 data-table work |
| UX-007 | search-input       | PENDING   | DONE     | DONE     | PENDING | contact_manager   | contact_manager,support_tickets                                  | 1        | 2026-04-12 | contract documented retroactively (cycle 4); refactor done as part of UX-002 |
| UX-008 | pagination         | PENDING   | DONE     | DONE     | PENDING | contact_manager   | contact_manager,support_tickets                                  | 1        | 2026-04-12 | contract documented retroactively (cycle 5); refactor done as part of UX-002 |
...
| UX-013 | toast              | PENDING   | DONE     | DONE     | PENDING | simple_task       | all                                                              | 1        | 2026-04-12 | contract + fragment refactor done; dzToast Alpine unchanged; QA deferred (event-triggered) |
