...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 6        | 2026-04-13 | Macro + grid/list/kanban/tabbed_list/queue/metrics. **6/16 adopters complete.** 10 region files remaining. |
