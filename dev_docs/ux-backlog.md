...
| UX-035 | region-wrapper     | READY_FOR_QA | DONE     | PARTIAL  | PENDING | ops_dashboard     | all workspace regions                                            | 8        | 2026-04-13 | + tree.html. **8/16 adopters complete.** 8 region files remaining. |
