...
Guidance for Codex when working with the DAZZLE codebase.
...
Downstream Dazzle users can author their own `trial.toml` via the `qa-trial` skill (`.Codex/skills/qa-trial/SKILL.md`). Each user domain stress-tests a different surface of the framework — aligns with the convergence hypothesis in ROADMAP.md.
...
---
**Version**: 0.61.13 | **Python**: 3.12+ | **Status**: Production Ready
