...
SHIP_TESTS: tuple[str, ...] = (
    ...
    # cycle 2384: related empty must not dump Task · Assigned To (oral #217)
    "tests/unit/test_related_empty_fk_dump.py",
    # cycle 2385: fetch-error empty must not invent collection-empty (oral #218)
    "tests/unit/test_empty_loading_entity_dump.py",
    # cycle 2386: chart empty must not dump generic No data (oral #219)
    "tests/unit/test_empty_chart_entity_dump.py",
    # cycle 2388: bulk confirm must not dump generic items (oral #220)
    "tests/unit/test_bulk_selection_entity_dump.py",
    # cycle 2389: FTS empty must not dump generic No results (oral #221)
    ...
    # cycle 2392: tree empty must not dump generic No items (oral #224)
    ...
    # cycle 2399: open-via hop phrases must not dump assigned to (oral #231)
    ...
    # cycle 2404: form submit must not dump generic Create/Save (oral #234)
    "tests/unit/test_form_submit_label_dump.py",
    # cycle 2405: detail delete must not dump generic Delete (oral #235)
